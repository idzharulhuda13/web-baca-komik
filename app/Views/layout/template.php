...
<div class="footer-2-1" style="font-family: 'Poppins', sans-serif">
    <div class="list-footer">
        <div class="row gap-md-0 gap-3">
            <div class="col-lg-3 col-md-6">
                <div class="">
                    <a href="<?= base_url('/'); ?>" class="btn btn-primary mb-5">Baca Komik</a>
                    <nav class="list-unstyled">
                        <li class="list-space">
                            <a href="/komik/" class="list-menu">Daftar Komik</a>
                        </li>
                        <li class="list-space">
                            <a href="/pengunjung/" class="list-menu">Pengunjung</a>
                        </li>
                    </nav>
                </div>
            </div>
    ...
    <div class="border-color info-footer">
        ...
        <div class="mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space gap-4">
            ...
            <nav class="d-flex flex-lg-row flex-column align-items-center justify-content-center">
                <p style="margin: 0">Copyright © 2021 Idzharul Huda</p>
            </nav>
        </div>
    </div>
</div>
